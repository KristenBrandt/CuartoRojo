          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-center space-x-2">
                ...
                <a href="tel:+525512345678" className="text-gray-300 hover:text-primary transition-colors">
                  +502 1234 5678
                </a>
              </div>
              <div className="flex items-center space-x-2">
                <Mail size={16} className="text-primary" />
                <a href="mailto:info@cuartorojo.com" className="text-gray-300 hover:text-primary transition-colors">
                  info@cuartorojo.com
                </a>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center space-x-4 pt-2">
                <a href="https://instagram.com/cuartorojo" className="text-gray-300 hover:text-primary transition-colors">
                  <Instagram size={20} />
                </a>
                <a href="https://wa.me/525512345678" className="text-gray-300 hover:text-primary transition-colors">
